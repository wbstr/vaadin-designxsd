...
import com.wcs.maven.designxsd.elementbuilder.factorytestclasses.NoArgConstructorLess;
import com.wcs.maven.designxsd.elementbuilder.factorytestclasses.PublicConstructorLess;
...
public class ElementBuilderFactoryTest {
    ...
    @Before
    public void setUp() {
        instance = new ElementBuilderFactory(null, null, new DesignContext());
    }
