 ...
 * @author lali
 */
public class MenuElementBuilder extends ComponentElementBuilder {
    
    private static final QName MENU_TAG = new QName("menu");
    
    public MenuElementBuilder(AttributeBuilderFactory attributeBuilderFactory, BaseAttributeGroupMngr baseAttributeGroupMngr, DesignContext designContext) {
