 ...
 * @author lali
 */
public class NodeComponentElementBuilder extends ComponentElementBuilder {

    private static final QName NODE_TAG = new QName("node");

    public NodeComponentElementBuilder(AttributeBuilderFactory attributeBuilderFactory, BaseAttributeGroupMngr baseAttributeGroupMngr, DesignContext designContext) {
